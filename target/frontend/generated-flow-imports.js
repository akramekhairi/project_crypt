...
import $css_0 from '@vaadin/flow-frontend/com/github/appreciated/apexcharts/apexcharts-wrapper-styles.css';
addCssBlock(`<dom-module id="apex-charts-style"><template><style>${$css_0}</style></template></dom-module>`);
